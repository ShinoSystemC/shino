...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.ps_dma_fft xil_defaultlib.glbl -o ps_dma_fft_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./ps_dma_fft_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key ps_dma_fft_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc ps_dma_fft_simv.daidir vcs_lib c.obj)
