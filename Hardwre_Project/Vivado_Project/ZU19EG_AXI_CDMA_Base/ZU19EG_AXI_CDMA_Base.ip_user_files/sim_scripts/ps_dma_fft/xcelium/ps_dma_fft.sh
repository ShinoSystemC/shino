...
#
# Script generated by Vivado on Sun Sep 13 19:31:17 +0800 2026
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : ps_dma_fft.sh
...
#
# Usage        : ps_dma_fft.sh
#                ps_dma_fft.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                ps_dma_fft.sh [-reset_run]
#                ps_dma_fft.sh [-reset_log]
#                ps_dma_fft.sh [-help]
#
...
#                script (type 'ps_dma_fft.sh -help' for more information).
#
...
design_libs_elab="-libname xilinx_vip -libname xpm -libname xbip_utils_v3_0_10 -libname axi_utils_v2_0_6 -libname c_reg_fd_v12_0_6 -libname xbip_dsp48_wrapper_v3_0_4 -libname xbip_pipe_v3_0_6 -libname xbip_dsp48_addsub_v3_0_6 -libname xbip_addsub_v3_0_6 -libname c_addsub_v12_0_15 -libname c_mux_bit_v12_0_6 -libname c_shift_ram_v12_0_14 -libname xbip_bram18k_v3_0_6 -libname mult_gen_v12_0_18 -libname cmpy_v6_0_21 -libname floating_point_v7_0_20 -libname xfft_v9_1_9 -libname xil_defaultlib -libname axi_infrastructure_v1_1_0 -libname axi_vip_v1_1_14 -libname zynq_ultra_ps_e_vip_v1_0_14 -libname lib_pkg_v1_0_2 -libname fifo_generator_v13_2_8 -libname lib_fifo_v1_0_17 -libname lib_srl_fifo_v1_0_2 -libname lib_cdc_v1_0_2 -libname axi_datamover_v5_1_30 -libname axi_sg_v4_1_16 -libname axi_dma_v7_1_29 -libname generic_baseblocks_v2_1_0 -libname axi_register_slice_v2_1_28 -libname axi_data_fifo_v2_1_27 -libname axi_crossbar_v2_1_29 -libname axi_bram_ctrl_v4_1_8 -libname blk_mem_gen_v8_4_6 -libname proc_sys_reset_v5_0_13 -libname axi_lite_ipif_v3_0_4 -libname interrupt_control_v3_1_4 -libname axi_gpio_v2_0_30 -libname axi_protocol_converter_v2_1_28 -libname xlconcat_v2_1_4 -libname xilinx_vip -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xilinx_vip xpm xbip_utils_v3_0_10 axi_utils_v2_0_6 c_reg_fd_v12_0_6 xbip_dsp48_wrapper_v3_0_4 xbip_pipe_v3_0_6 xbip_dsp48_addsub_v3_0_6 xbip_addsub_v3_0_6 c_addsub_v12_0_15 c_mux_bit_v12_0_6 c_shift_ram_v12_0_14 xbip_bram18k_v3_0_6 mult_gen_v12_0_18 cmpy_v6_0_21 floating_point_v7_0_20 xfft_v9_1_9 xil_defaultlib axi_infrastructure_v1_1_0 axi_vip_v1_1_14 zynq_ultra_ps_e_vip_v1_0_14 lib_pkg_v1_0_2 fifo_generator_v13_2_8 lib_fifo_v1_0_17 lib_srl_fifo_v1_0_2 lib_cdc_v1_0_2 axi_datamover_v5_1_30 axi_sg_v4_1_16 axi_dma_v7_1_29 generic_baseblocks_v2_1_0 axi_register_slice_v2_1_28 axi_data_fifo_v2_1_27 axi_crossbar_v2_1_29 axi_bram_ctrl_v4_1_8 blk_mem_gen_v8_4_6 proc_sys_reset_v5_0_13 axi_lite_ipif_v3_0_4 interrupt_control_v3_1_4 axi_gpio_v2_0_30 axi_protocol_converter_v2_1_28 xlconcat_v2_1_4)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "ps_dma_fft.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./ps_dma_fft.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.ps_dma_fft xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.ps_dma_fft -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log ps_dma_fft_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./ps_dma_fft.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: ps_dma_fft.sh [-help]\n\
Usage: ps_dma_fft.sh [-step]\n\
Usage: ps_dma_fft.sh [-lib_map_path]\n\
Usage: ps_dma_fft.sh [-reset_run]\n\
Usage: ps_dma_fft.sh [-reset_log]\n\
Usage: ps_dma_fft.sh [-keep_index]\n\
Usage: ps_dma_fft.sh [-noclean_files]\n\n\
